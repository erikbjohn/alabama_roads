...
```{r, echo=FALSE, eval=TRUE, cache=TRUE, out.width = "300px", }
knitr::include_graphics(paste0(pkg.data.location, 'raw/training_data/guardrail/22guardrail.jpg'))
```

# 
```{r, echo=FALSE, eval=TRUE, out.width = "300px"}
knitr::include_graphics(paste0(pkg.data.location, 'raw/training_data/signals/09signals.jpg'))
```
